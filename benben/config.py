    ...
    "markdown": [
        ...
        },
        {
            ...
            "items": [
                ...
                {
                    "name": "指标卡（KPI）（自建模板，非官方语法）",
                    "code": ":::kpi\n- **指标一**: 95%\n- **指标二**: 120\n- **指标三**: 完成\n:::\n",
                },
                {
                    "name": "左右两栏布局（自建模板，非官方语法）",
                    "code": ":::cols\n左侧内容\n\n右侧内容\n:::\n",
                },
                {
                    "name": "三栏特性（自建模板，非官方语法）",
                    "code": ":::features\n- 特性一\n- 特性二\n- 特性三\n:::\n",
                },
                {
                    "name": "封面（自建模板，非官方语法）",
                ...
                {
                    "name": "章节分割（自建模板，非官方语法）",
                    "code": ":::divider\n:::\n",
                },
                {
                    "name": "横幅提示（自建模板，非官方语法）",
                    "code": ":::banner\n**要点**：在这里写一段醒目的提示文本。\n:::\n",
                },
                {
                    "name": "讲稿备注（仅显示在编辑器，导出为小字）（自建模板，非官方语法）",
                    "code": ":::notes\n讲者备注：仅供备忘，不作为正文展示。\n:::\n",
                },
                {
                    "name": "代码与说明并列（自建模板，非官方语法）",
                    "code": ":::code-split\n```python\nprint('示例')\n```\n\n说明：在右侧写解释文本。\n:::\n",
                },
            ],
        },
        ...
        },
        {
            ...
            "items": [
                ...
                {
                    "name": "左右两列图片（自建模板，非官方语法）",
                    "code": ":::img-2\n![](图片1地址)\n![](图片2地址)\n:::\n",
                },
                {
                    "name": "上下两列图片（自建模板，非官方语法）",
                    "code": ":::img-2v\n![](图片1地址)\n![](图片2地址)\n:::\n",
                },
                {
                    "name": "田字四图（自建模板，非官方语法）",
                    "code": ":::img-4\n![](图片1地址)\n![](图片2地址)\n![](图片3地址)\n![](图片4地址)\n:::\n",
                },
            ],
        },
